...
interface DealStageManagerProps {
  stages: DealStage[];
  onAddStage: () => void;
  onEditStage: (stage: DealStage) => void;
  onDeleteStage: (stageId: string) => void;
  onReorderStages: (stages: DealStage[]) => void;
}

export const DealStageManager: React.FC<DealStageManagerProps> = ({
  stages,
  onAddStage,
  onEditStage,
  onDeleteStage,
        ...
        <div className="space-y-4">
          ...
          <div className="pt-4 border-t">
            <p className="text-xs text-muted-foreground">
              💡 <strong>Dica:</strong> Arraste os negócios entre as etapas para movê-los no funil. 
