    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal hover:bg-secondary/80 focus:bg-secondary [&[aria-selected=true]]:bg-primary [&[aria-selected=true]]:text-primary-foreground [&[aria-selected=true]]:hover:bg-primary [&[aria-selected=true]]:border-0"
        ),
        ...
        day_today: "bg-transparent text-foreground border border-muted-foreground/30 font-medium",
        day_outside:
