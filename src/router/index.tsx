...
const InboxAuditLogsPage = React.lazy(() => import('../pages/admin/InboxAuditLogsPage').then(module => ({ default: module.InboxAuditLogsPage })));
const ClientInboxesPage = React.lazy(() => import('../pages/admin/ClientInboxesPage').then(module => ({ default: module.ClientInboxesPage })));
...
export const router = createBrowserRouter([
  ...
  // Admin routes
  {
    ...
    children: [
      ...
      {
        path: 'clients/:accountId/inboxes',
        element: (
          <Suspense fallback={<PageLoader />}>
            <ClientInboxesPage />
          </Suspense>
